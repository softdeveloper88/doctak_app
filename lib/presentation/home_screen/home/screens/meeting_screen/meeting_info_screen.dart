    ...
    return [
      {
        ...
        "description": translation(context).desc_start_stop_meeting,
        "icon": Icons.play_circle_outline_rounded,
      },
      {
        "title": translation(context).lbl_mute_all_participants,
        "description": translation(context).desc_mute_all_participants,
        "icon": Icons.mic_off_rounded,
      },
      {
        "title": translation(context).lbl_unmute_all_participants,
        "description": translation(context).desc_unmute_all_participants,
        "icon": Icons.mic_rounded,
      },
      {
        "title": translation(context).lbl_add_remove_host,
        "description": translation(context).desc_add_remove_host,
        "icon": Icons.person_add_alt_1_rounded,
      },
      {
        "title": translation(context).lbl_share_screen,
        "description": translation(context).desc_share_screen,
        "icon": Icons.screen_share_rounded,
      },
      {
        "title": translation(context).lbl_raise_hand,
        "description": translation(context).desc_raise_hand,
        "icon": Icons.back_hand_rounded,
      },
      {
        "title": translation(context).lbl_send_reactions,
        "description": translation(context).desc_send_reactions,
        "icon": Icons.emoji_emotions_rounded,
      },
      {
        "title": translation(context).lbl_toggle_microphone,
        "description": translation(context).desc_toggle_microphone,
        "icon": Icons.settings_voice_rounded,
      },
      {
        "title": translation(context).lbl_toggle_video,
        "description": translation(context).desc_toggle_video,
        "icon": Icons.videocam_rounded,
      },
      {
        "title": translation(context).lbl_enable_waiting_room,
        "description": translation(context).desc_enable_waiting_room,
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                child: Column(
                  children: List.generate(getMeetingOptions(context).length, (
                    index,
                  ) {
                    final option = getMeetingOptions(context)[index];
                    final isLast =
                        index == getMeetingOptions(context).length - 1;
