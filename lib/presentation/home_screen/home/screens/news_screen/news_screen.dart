...
class _NewsScreenState extends State<NewsScreen> {
  ...
  Widget buildNewsTab(List<NewsModel> news) {
    return news.isEmpty
        ? Center(
            child: Text(translation(context).msg_no_news_found),
          )
        : ListView.builder(
                  ...
                  child: Column(
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          TextButton(
                            child: Text(translation(context).lbl_read_more),
  ...
  Future<void> _launchURL(String urlString) async {
    ...
    if (shouldLaunch) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text('${translation(context).msg_could_not_launch} $urlString'),
