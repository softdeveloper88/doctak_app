...
class TagFriendsListBottomSheet extends StatefulWidget {
  ...
  const TagFriendsListBottomSheet(this.searchPeopleBloc, {super.key});

  @override
  State<TagFriendsListBottomSheet> createState() => _TagFriendsListBottomSheetState();
}
...
class _TagFriendsListBottomSheetState extends State<TagFriendsListBottomSheet> {
        ...
        children: [
          ...
          Center(
            child: Container(
              ...
              width: 40,
              height: 4,
              decoration: BoxDecoration(color: theme.textTertiary.withValues(alpha: 0.4), borderRadius: BorderRadius.circular(2)),
            ),
          ),
          // Header
          Container(
            ...
            child: Row(
              children: [
                Container(
                  ...
                  child: Icon(CupertinoIcons.person_2_fill, color: theme.primary, size: 22),
                ),
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      Text(
                        'Tag Friends',
                        style: TextStyle(fontSize: 20, fontWeight: FontWeight.w700, fontFamily: 'Poppins', color: theme.textPrimary, letterSpacing: -0.3),
                      ),
                      Text(
                ...
                Material(
                  ...
                  child: InkWell(
                    ...
                    child: Container(
                      ...
                      child: Icon(CupertinoIcons.xmark, color: theme.textSecondary, size: 18),
                    ),
                  ),
                ),
              ],
            ...
            child: Row(
              children: [
                Padding(
                  ...
                  child: Icon(CupertinoIcons.search, color: theme.textTertiary, size: 20),
                ),
                Expanded(
                  child: TextField(
                  ...
                  Padding(
                    ...
                    child: GestureDetector(
                      ...
                      child: Container(
                        ...
                        child: Icon(CupertinoIcons.xmark, size: 14, color: theme.textSecondary),
                      ),
                    ),
                  ),
              ],
                ...
                return Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      Row(
                        children: [
                          Icon(CupertinoIcons.checkmark_circle_fill, size: 16, color: theme.primary),
                      ...
                      Wrap(
                        spacing: 8,
                        runSpacing: 8,
                        children: widget.searchPeopleBloc.selectedSearchPeopleData.map((person) {
          ...
          // Divider
          Container(height: 0.5, margin: const EdgeInsets.symmetric(horizontal: 16), color: theme.divider),
          // Friends List
          Expanded(
                ...
                if (state is PaginationLoadingState) {
                  return Center(
                    child: Column(
                      ...
                      children: [
                        CupertinoActivityIndicator(color: theme.primary, radius: 14),
                  ...
                  return ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      final isSelected = bloc.selectedSearchPeopleData.any((p) => p.id == person.id);
  ...
  Widget _buildSelectedChip(dynamic person, OneUITheme theme) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(color: theme.primary.withValues(alpha: 0.25), width: 1),
      ...
      child: Row(
        ...
        children: [
          ...
          GestureDetector(
            onTap: () {
              widget.searchPeopleBloc.add(SelectFriendEvent(userData: person, isAdd: false));
            },
            child: Container(
              width: 18,
              height: 18,
              decoration: BoxDecoration(color: theme.error.withValues(alpha: 0.12), shape: BoxShape.circle),
  ...
  Widget _buildFriendListItem(dynamic person, bool isSelected, OneUITheme theme) {
    return Container(
      margin: const EdgeInsets.only(bottom: 8),
      child: Material(
        color: isSelected ? theme.primary.withValues(alpha: 0.08) : theme.cardBackground,
        borderRadius: BorderRadius.circular(14),
        child: InkWell(
          onTap: () {
            widget.searchPeopleBloc.add(SelectFriendEvent(userData: person, isAdd: !isSelected));
          },
          borderRadius: BorderRadius.circular(14),
          child: Container(
            padding: const EdgeInsets.all(12),
            decoration: BoxDecoration(
              borderRadius: BorderRadius.circular(14),
              border: Border.all(color: isSelected ? theme.primary.withValues(alpha: 0.3) : theme.border, width: isSelected ? 1.5 : 0.5),
            ),
            child: Row(
              children: [
                // Avatar
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    boxShadow: [BoxShadow(color: theme.primary.withValues(alpha: 0.1), blurRadius: 6, offset: const Offset(0, 2))],
                  ),
                  child: ClipRRect(
                    ...
                    child: person.profilePic?.isNotEmpty == true
                        ? CachedNetworkImage(
                            ...
                            errorWidget: (context, url, error) => _buildAvatarPlaceholder(person, theme),
                          )
                ...
                Expanded(
                  child: Text(
                    '${person.firstName ?? ''} ${person.lastName ?? ''}'.trim(),
                    style: TextStyle(fontSize: 15, fontWeight: FontWeight.w600, fontFamily: 'Poppins', color: theme.textPrimary),
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    shape: BoxShape.circle,
                    border: isSelected ? null : Border.all(color: theme.border, width: 1.5),
                  ),
                  child: isSelected ? const Icon(CupertinoIcons.checkmark, color: Colors.white, size: 16) : Icon(CupertinoIcons.plus, color: theme.textTertiary, size: 16),
                ),
              ],
            ),
          ),
  ...
  Widget _buildAvatarPlaceholder(dynamic person, OneUITheme theme) {
    return Container(
      ...
      child: Center(
        child: Text(
          person.firstName?.substring(0, 1).toUpperCase() ?? '?',
          style: TextStyle(color: theme.primary, fontSize: 20, fontWeight: FontWeight.bold, fontFamily: 'Poppins'),
        ),
      ),
    );
  }
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          Text(
            'No friends found',
            style: TextStyle(fontSize: 17, fontWeight: FontWeight.w600, color: theme.textPrimary, fontFamily: 'Poppins'),
          ),
      ...
      child: Column(
        ...
        children: [
          Container(
            ...
            child: Icon(CupertinoIcons.exclamationmark_circle, size: 40, color: theme.error),
          ),
          const SizedBox(height: 16),
          Text(
