...
class SVPostTextComponent extends StatefulWidget {
  ...
  const SVPostTextComponent({this.onColorChange, this.colorValue, required this.searchPeopleBloc, this.textController, super.key});
...
class _SVPostTextComponentState extends State<SVPostTextComponent> {
  ...
  Color _getTextColor(Color? backgroundColor, OneUITheme theme) {
    if (backgroundColor == null || backgroundColor == Colors.transparent || backgroundColor == theme.inputBackground) {
  ...
  Widget build(BuildContext context) {
    ...
    final bool hasCustomBackground = widget.colorValue != null && widget.colorValue != Colors.transparent && widget.colorValue != theme.scaffoldBackground;
      ...
      child: ClipRRect(
        ...
        child: Column(
          ...
          children: [
            // Text Input Area
            Container(
              constraints: BoxConstraints(minHeight: MediaQuery.of(context).size.height > 800 ? 180 : 140),
              decoration: BoxDecoration(
                color: hasCustomBackground ? widget.colorValue : theme.inputBackground,
              ...
              child: TextFormField(
                ...
                style: TextStyle(fontSize: 16, fontFamily: 'Poppins', color: _getTextColor(hasCustomBackground ? widget.colorValue : null, theme), height: 1.5, fontWeight: FontWeight.w400),
                onChanged: (value) {
                ...
                decoration: InputDecoration(
                  ...
                  hintStyle: TextStyle(fontSize: 16, fontFamily: 'Poppins', color: _getHintTextColor(hasCustomBackground ? widget.colorValue : null, theme), fontWeight: FontWeight.w400),
                        ...
                        child: Row(
                          ...
                          children: [
                            Container(
                              ...
                              height: 20,
                              decoration: BoxDecoration(
                                gradient: LinearGradient(colors: [Colors.red, Colors.orange, Colors.yellow, Colors.green, Colors.blue], begin: Alignment.topLeft, end: Alignment.bottomRight),
                            ...
                            Text(
                              'Background',
                              style: TextStyle(color: theme.primary, fontSize: 14, fontWeight: FontWeight.w600, fontFamily: 'Poppins'),
                            ),
                          ],
                        ),
                      ),
