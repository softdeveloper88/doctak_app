...
List<SVDrawerModel> getDrawerOptions(BuildContext context) {
  ...
  list.add(SVDrawerModel(image: 'assets/icon/ic_discount.png', title: 'Artificial Intelligence'));
  ...
  list.add(SVDrawerModel(image: 'assets/icon/ic_conference.png', title: 'DocTak Polls'));
