...
class _LanguageSelectionScreenState extends State<LanguageSelectionScreen>
  ...
  Future<void> _selectLanguage(String languageCode) async {
    ...
    // Save language and first-time flag using SecureStorageService (reliable in release mode)
    ...
    // Also try nb_utils setValue as backup (may fail in release mode)
    try {
      await setValue('is_first_time', false);
    } catch (e) {
      debugPrint('nb_utils setValue failed: $e');
    }
