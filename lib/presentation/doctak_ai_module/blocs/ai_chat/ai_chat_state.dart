...
class SessionsLoadError extends AiChatState {
  ...
  const SessionsLoadError({required this.message, this.sessions});
...
class SessionCreating extends AiChatState {
  ...
  const SessionCreating({required this.sessions});
...
class SessionCreated extends AiChatState {
  ...
  const SessionCreated({required this.sessions, required this.newSession});
...
class SessionCreateError extends AiChatState {
  ...
  const SessionCreateError({required this.message, required this.sessions});
...
class SessionLoading extends AiChatState {
  ...
  const SessionLoading({required this.sessions});
...
class SessionLoadError extends AiChatState {
  ...
  const SessionLoadError({required this.message, required this.sessions, this.selectedSession, this.messages});
...
class MessageSending extends AiChatState {
  ...
  const MessageSending({required this.sessions, required this.selectedSession, required this.messages, this.isFirstMessage = false});
...
class MessageStreaming extends AiChatState {
  ...
  const MessageStreaming({required this.sessions, required this.selectedSession, required this.messages, this.isFirstMessage = false, required this.partialResponse});
  ...
  MessageStreaming copyWithPartialResponse(String newPartialResponse) {
    return MessageStreaming(sessions: sessions, selectedSession: selectedSession, messages: messages, isFirstMessage: isFirstMessage, partialResponse: newPartialResponse);
  }
}
...
class SessionDeleting extends AiChatState {
  ...
  const SessionDeleting({required this.sessions});
...
class SessionDeleted extends AiChatState {
  ...
  const SessionDeleted({required this.sessions, this.nextSession});
...
class SessionDeleteError extends AiChatState {
  ...
  const SessionDeleteError({required this.message, required this.sessions});
...
class SessionUpdating extends AiChatState {
  ...
  const SessionUpdating({required this.sessions, this.selectedSession, required this.messages});
...
class SessionUpdateError extends AiChatState {
  ...
  const SessionUpdateError({required this.message, required this.sessions});
...
class FeedbackError extends AiChatState {
  ...
  const FeedbackError({required this.message, required this.sessions, required this.selectedSession, required this.messages});
