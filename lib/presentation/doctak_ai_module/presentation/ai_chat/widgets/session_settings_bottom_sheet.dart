  ...
  Widget build(BuildContext context) {
    return Container(
      decoration: BoxDecoration(
        ...
        boxShadow: [BoxShadow(color: Colors.blue.withValues(alpha: 0.1), blurRadius: 20, spreadRadius: 0, offset: const Offset(0, -5))],
      ),
        ...
        children: [
          ...
          Row(
            children: [
              ...
              Text(
                'Chat Settings',
                style: const TextStyle(fontSize: 20, fontWeight: FontWeight.w600, fontFamily: 'Poppins', color: Colors.black87),
              ),
            ],
          ),
          const SizedBox(height: 16),
                          ...
                          children: [
                              ...
                              children: [
                                ...
                                Container(
                                  decoration: BoxDecoration(
                                    ...
                                    borderRadius: BorderRadius.circular(12),
                                    boxShadow: [BoxShadow(color: Colors.blue.withValues(alpha: 0.3), offset: const Offset(0, 2), blurRadius: 8, spreadRadius: 0)],
                                  ),
                                      ...
                                      if (newName.isNotEmpty) {
                                        ...
                                        if (newName.length > 50) {
                                          ScaffoldMessenger.of(context).showSnackBar(
                                            SnackBar(
                                              content: const Text('Session name must be 50 characters or less', style: TextStyle(fontFamily: 'Poppins')),
                                                ...
                                                child: AlertDialog(
                                                  content: Row(
                                                    children: [
                                                      ...
                                                      Expanded(
                                                        child: Text('Renaming session to "$newName"...', style: const TextStyle(fontFamily: 'Poppins')),
                                                      ),
                                                    ],
                                                  ),
                                        ...
                                        try {
                                          ...
                                          if (mounted) {
                                            ...
                                            ScaffoldMessenger.of(context).showSnackBar(
                                              SnackBar(
                                                content: Text('Session renamed to "$newName"', style: const TextStyle(fontFamily: 'Poppins')),
                                                behavior: SnackBarBehavior.floating,
                                                duration: const Duration(seconds: 2),
                                                backgroundColor: Colors.blue[600],
                                              ),
                                          ...
                                          if (mounted) {
                                            ...
                                            ScaffoldMessenger.of(context).showSnackBar(
                                              SnackBar(
                                                content: Text('Failed to rename session: ${e.toString()}', style: const TextStyle(fontFamily: 'Poppins')),
                                                behavior: SnackBarBehavior.floating,
                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  child: Text(
                                    ...
                                    style: TextStyle(color: Colors.blue[600], fontWeight: FontWeight.w600, fontFamily: 'Poppins'),
                                  ),
                                ),
                              ],
                            ),
                            ...
                            SliderTheme(
                              data: SliderTheme.of(context).copyWith(
                                ...
                                valueIndicatorTextStyle: const TextStyle(color: Colors.white, fontFamily: 'Poppins', fontWeight: FontWeight.w500),
                              ),
                              child: Slider(
                                value: _temperature,
                                min: 0,
