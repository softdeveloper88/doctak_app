...
class _EnhancedChatInputFieldState extends State<EnhancedChatInputField>
  ...
  void _initAnimations() {
    ...
    _buttonTransitionController = AnimationController(
      duration: const Duration(milliseconds: 200),
      vsync: this,
    );
    _buttonTransitionAnimation = CurvedAnimation(
      parent: _buttonTransitionController,
          ...
          child: Transform.scale(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                boxShadow: [
                  BoxShadow(
                    color: theme.primary.withOpacity(_isPressed ? 0.5 : 0.3),
