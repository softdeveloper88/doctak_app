                        ...
                        children: [
                            ...
                            child: GestureDetector(
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  boxShadow: [BoxShadow(color: theme.isDark ? Colors.black.withValues(alpha: 0.2) : Colors.black.withValues(alpha: 0.04), blurRadius: 8, offset: const Offset(0, 2))],
                                ),
                                child: Icon(Icons.arrow_back_ios_new_rounded, size: 20, color: theme.primary),
                              ),
                            ),
                          ),
                          ...
                          Hero(
                            ...
                            child: Container(
                              ...
                              child: Image.asset('assets/logo/logo.png', width: MediaQuery.of(context).size.width * 0.15),
                            ),
                          ),
                          const SizedBox(height: 32),
                          // Title
                              ...
                              children: [
                                ...
                                CustomTextFormField(
                                  ...
                                  prefix: Container(
                                    ...
                                    child: Icon(Icons.email_outlined, color: theme.primary, size: 20),
                                  ),
                                  ...
                                  Padding(
                                    ...
                                    child: Container(
                                      ...
                                      decoration: BoxDecoration(
                                        ...
                                        border: Border.all(color: theme.error.withValues(alpha: 0.3), width: 0.5),
                                      ),
                                      child: Row(
                                        children: [
                                ...
                                theme.buildAuthPrimaryButton(
                                  ...
                                  onPressed: () {
                                    ...
                                    if (_formKey.currentState!.validate()) {
                                      ...
                                      forgotBloc.add(ForgotPasswordEvent(username: emailController.text));
                                    }
                                  },
                                ),
                          ...
                          GestureDetector(
                            ...
                            child: Container(
                              ...
                              child: Row(
                                ...
                                children: [
                                  Icon(Icons.arrow_back_rounded, size: 18, color: theme.primary),
                                  const SizedBox(width: 8),
                                  Text(
                                    'Back to ${translation(context).lbl_login}',
                                    style: TextStyle(fontFamily: 'Poppins', fontSize: 14, fontWeight: FontWeight.w600, color: theme.primary),
                                  ),
                                ],
                              ),
                            ),
