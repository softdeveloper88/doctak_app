...
class _GroupMemberScreenState extends State<GroupMemberScreen> {
  ...
  @override
  void initState() {
    admins = widget.groupBloc.groupMemberModel!.groupMembers!
        .where((member) => member.adminType == 'admin')
        .toList();
    user = widget.groupBloc.groupMemberModel!.groupMembers!
        .where((member) => member.adminType == 'user')
        .toList();
...
class SectionTitle extends StatelessWidget {
  ...
  SectionTitle({required this.title, required this.count});
