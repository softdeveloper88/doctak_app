                            ...
                            children: [
                              Container(
                                decoration: BoxDecoration(
                                  image: DecorationImage(image: CachedNetworkImageProvider(groupBloc.groupDetailsModel?.group?.banner ?? ''), fit: BoxFit.cover),
                                  color: context.cardColor,
                                ),
                                width: 100.w,
                                height: 35.w,
                              ...
                              Positioned(
                                ...
                                child: Container(
                                  decoration: BoxDecoration(
                                    image: DecorationImage(image: CachedNetworkImageProvider(groupBloc.groupDetailsModel?.group?.logo ?? ''), fit: BoxFit.cover),
                                    color: svGetBgColor(),
                                    border: Border.all(color: Colors.grey),
                                    borderRadius: BorderRadius.circular(100),
                                  ),
                          ...
                          child: Row(
                            children: [
                              ...
                              Text(
                                ...
                                style: TextStyle(color: Colors.black45, fontSize: 10.sp, fontWeight: FontWeight.w400),
                              ),
                            ],
                          ),
                        ),
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                child: IconButton(
                                  icon: const Row(mainAxisAlignment: MainAxisAlignment.center, children: [Icon(Icons.group), Text(" Joined")]),
                                  color: Colors.grey,
                                  onPressed: () {},
                                ),
                              ),
                              ...
                              Container(
                                ...
                                child: IconButton(icon: const Icon(Icons.share), color: Colors.grey, onPressed: () {}),
                              ),
                            ],
                          ),
                        ),
                            ...
                            Container(
                              ...
                              child: Center(
                                child: TextField(
                                  ...
                                  decoration: const InputDecoration.collapsed(hintText: 'Write And Share Your Post...'),
                                  maxLines: null,
                              ...
                              Container(
                                ...
                                child: IconButton(
                                  icon: Row(
                                    mainAxisAlignment: MainAxisAlignment.center,
                                    children: [
                                      const Icon(Icons.live_tv, color: Colors.black),
                                      Text(
                                        " Live",
                                        style: TextStyle(fontWeight: FontWeight.w500, color: Colors.black),
                                      ),
        ...
        child: SingleChildScrollView(
          child: Column(
            children: <Widget>[
              ...
              const SizedBox(height: 10),
              Text(groupBloc?.groupDetailsModel?.group?.name ?? "", style: const TextStyle(color: Colors.white, fontSize: 22)),
              Text(
                '${groupBloc?.groupDetailsModel?.group?.privacySetting ?? ''} Group . ${groupBloc?.groupDetailsModel?.totalMembers ?? ""} members',
                style: const TextStyle(color: Colors.white, fontSize: 14),
              ),
              const Divider(color: Colors.white, thickness: 1, indent: 0, endIndent: 50),
              DrawerItem(
                onTap: () {
              ...
              const Divider(color: Colors.white, thickness: 1, indent: 0, endIndent: 50),
              DrawerItem(onTap: () {}, icon: Icons.post_add, text: 'View post request', trailing: '${groupBloc?.groupPostModel?.posts?.length ?? '0'}'),
              const Divider(color: Colors.white, thickness: 1, indent: 0, endIndent: 50),
              DrawerItem(
                onTap: () {
                  if (groupBloc?.groupDetailsModel?.isAdmin ?? false) {
              ...
              const Divider(color: Colors.white, thickness: 1, indent: 0, endIndent: 50),
              DrawerItem(icon: Icons.settings, text: 'Group Setting'),
              const Divider(color: Colors.white, thickness: 1, indent: 0, endIndent: 50),
              DrawerItem(icon: Icons.exit_to_app, text: 'Leave Group'),
            ],
          ),
        ),
      ),
...
class DrawerItem extends StatelessWidget {
  ...
  const DrawerItem({super.key, required this.icon, required this.text, this.trailing, this.onTap});
    ...
    return ListTile(
      ...
      trailing: trailing != null
          ? Container(
              ...
              child: Text(trailing!, style: const TextStyle(color: Colors.blue)),
            )
          : null,
      onTap: () => onTap!(),
    );
