...
class JobsShimmerLoader extends StatelessWidget {
  const JobsShimmerLoader({super.key});
          ...
          child: ClipRRect(
            ...
            child: Shimmer.fromColors(
              ...
              child: Column(
                ...
                children: [
                  _buildJobHeader(context, isLongTitle, hasSponsored, shimmerColor, theme),
  ...
  Widget _buildJobHeader(BuildContext context, bool isLongTitle, bool hasSponsored, Color shimmerColor, OneUITheme theme) {
    return Container(
          ...
          Expanded(
            child: Column(
              ...
              children: [
                Container(
                  height: 16,
                  width: isLongTitle ? double.infinity : MediaQuery.of(context).size.width * 0.5,
                ...
                if (hasSponsored) ...[
                  ...
                  Container(
                    ...
                    child: SizedBox(width: 60, height: 12),
                  ),
                ],
              ],
            ),
  ...
  Widget _buildJobContent(BuildContext context, Color shimmerColor, OneUITheme theme) {
    return Container(
      padding: const EdgeInsets.all(16),
      decoration: BoxDecoration(
  ...
  Widget _buildJobDetails(BuildContext context, Color shimmerColor, OneUITheme theme) {
    return Container(
      padding: const EdgeInsets.all(16),
      decoration: BoxDecoration(
        color: theme.cardBackground,
