...
class CustomCheckboxButton extends StatelessWidget {
  ...
  Widget get buildCheckBoxWidget => InkWell(
    ...
    child: Container(decoration: decoration, width: width, child: (isRightCheck ?? false) ? rightSideCheckbox : leftSideCheckbox),
  );
  ...
  Widget get textWidget => Text(text ?? "", textAlign: textAlignment ?? TextAlign.center, style: textStyle ?? CustomTextStyles.bodyMediumSFProDisplayErrorContainer);
