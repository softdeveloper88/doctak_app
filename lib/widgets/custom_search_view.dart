  ...
  InputDecoration get decoration => InputDecoration(
    ...
    prefixIcon:
        ...
        Container(
          ...
          child: CustomImageView(imagePath: imgRewind, height: 18, width: 18),
        ),
    prefixIconConstraints: prefixConstraints ?? const BoxConstraints(maxHeight: 40),
    suffixIcon:
        suffix ??
        Padding(
    ...
    suffixIconConstraints: suffixConstraints ?? const BoxConstraints(maxHeight: 40),
    isDense: true,
    contentPadding: contentPadding ?? const EdgeInsets.only(top: 12, right: 12, bottom: 12),
