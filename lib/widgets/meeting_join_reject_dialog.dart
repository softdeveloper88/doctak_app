...
class MeetingJoinRejectDialog extends StatelessWidget {
  ...
  const MeetingJoinRejectDialog({super.key, required this.title, required this.callback, this.callbackNegative, this.yesButtonText, this.noButtonText, this.joinName, this.profilePic});
...
Center confirmationMeetingJoinRejectDialog(BuildContext context, String title, VoidCallback callBack, String yesButtonText, String joinName, VoidCallback? callbackNegative, noButtonText, profilePic) {
  return Center(
    child: Column(
                        ...
                        child: Row(
                          ...
                          children: [
                            ClipRRect(
                              ...
                              child: CustomImageView(height: 50, width: 50, imagePath: profilePic),
                            ),
                            Expanded(
                              child: Padding(
                        ...
                        children: [
                              ...
                              child: MaterialButton(
                                ...
                                child: Center(
                                  child: Text(
                                    ...
                                    style: TextStyle(fontWeight: FontWeight.w600, color: Colors.white, fontSize: 12.sp),
                                  ),
                                ),
                              ),
                            ),
                          ...
                          Expanded(
                            child: Container(
                              width: 30.w,
                              height: 10.w,
                              decoration: BoxDecoration(color: Colors.blue, borderRadius: BorderRadius.circular(6.0)),
                              child: MaterialButton(
                                shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(6.0)),
                                onPressed: callBack,
                                child: Center(
