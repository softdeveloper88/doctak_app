...
enum PageTransitionType { slideFromRight, slideFromLeft, slideFromBottom, slideFromTop, fade, scale, rotate, noTransition }
...
class CustomPageRoute<T> extends PageRouteBuilder<T> {
  ...
  static SlideTransition _slideTransition(Animation<double> animation, Widget child, Offset begin) {
