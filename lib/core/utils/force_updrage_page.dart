  ...
  Future<void> _checkAppVersion() async {
    if (packageInfo != null) {
      ...
      if (latestVersionInfo.isNotEmpty) {
        ...
        setState(() {
          latestVersionString = latestVersionLocal ?? '1.0.1';
          currentVersionString = packageInfo!.version;
        });
      }
      ...
      child: Stack(
        ...
        children: [
          ...
          Container(
            ...
            child: Center(child: Icon(isSkippible ?? false ? Icons.rocket_launch_rounded : Icons.system_update_rounded, size: 50, color: Colors.white)),
    ...
    return Row(
      ...
      children: [
        for (int i = 0; i < 3; i++)
          ...
          ).animate().fadeIn(delay: (i * 200).ms, duration: 700.ms).then(delay: 300.ms).fadeOut(duration: 700.ms),
      ],
    );
  }
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: Stack(
                          ...
                          children: [
                            // Shimmer effect
                            if (isSkippible == false) Positioned.fill(child: _buildShimmerEffect()),
                            ...
                            ElevatedButton(
                              ...
                              child: Row(
                                ...
                                children: [
                                  Text(
                                    isSkippible ?? false ? 'Update Now' : 'Update Required',
                                    style: const TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: Colors.white),
                                  ),
                                  const SizedBox(width: 8),
                                  Icon(isSkippible ?? false ? Icons.file_download_outlined : Icons.priority_high_rounded, color: Colors.white, size: 20),
                                ],
                              ),
                            ),
                          ],
