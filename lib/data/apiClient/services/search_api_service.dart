...
class SearchApiService {
  ...
  Future<ApiResponse<Map<String, dynamic>>> globalSearch({required String page, required String keyword}) async {
    try {
      final response = await networkUtils.handleResponse(await networkUtils.buildHttpResponse('/search?page=$page&keyword=$keyword', method: networkUtils.HttpMethod.POST));
  ...
  Future<ApiResponse<SearchPeopleModel>> searchUsers({required String page, required String keyword, String? specialty, String? location}) async {
    try {
      ...
      final response = await networkUtils.handleResponse(await networkUtils.buildHttpResponse('/searchPeople?$queryParams', method: networkUtils.HttpMethod.GET));
  ...
  Future<ApiResponse<PostDataModel>> searchPosts({required String page, required String keyword}) async {
    try {
      final response = await networkUtils.handleResponse(await networkUtils.buildHttpResponse('/search/posts?page=$page&keyword=$keyword', method: networkUtils.HttpMethod.POST));
  ...
  Future<ApiResponse<DrugsModel>> searchDrugs({required String page, required String keyword}) async {
    try {
      final response = await networkUtils.handleResponse(await networkUtils.buildHttpResponse('/search/drugs?page=$page&keyword=$keyword', method: networkUtils.HttpMethod.POST));
  ...
  Future<ApiResponse<GuidelinesModel>> searchGuidelines({required String page, required String keyword, String? category}) async {
    try {
      ...
      final response = await networkUtils.handleResponse(await networkUtils.buildHttpResponse('/search/guidelines?$queryParams', method: networkUtils.HttpMethod.POST));
  ...
  Future<ApiResponse<CaseDiscussModel>> searchCases({required String page, required String keyword, String? specialty, String? difficulty}) async {
    try {
      String queryParams = 'page=$page&keyword=$keyword';
      if (specialty != null && specialty.isNotEmpty) {
        queryParams += '&specialty=$specialty';
      ...
      final response = await networkUtils.handleResponse(await networkUtils.buildHttpResponse('/search/cases?$queryParams', method: networkUtils.HttpMethod.POST));
  ...
  Future<ApiResponse<Map<String, dynamic>>> advancedSearch({
    ...
    try {
      ...
      final response = await networkUtils.handleResponse(await networkUtils.buildHttpResponse('/search/advanced', method: networkUtils.HttpMethod.POST, request: request));
      return ApiResponse.success(Map<String, dynamic>.from(response));
    } on ApiException catch (e) {
      return ApiResponse.error(e.message, statusCode: e.statusCode);
    } catch (e) {
  ...
  Future<ApiResponse<List<String>>> getSearchSuggestions({
    ...
    try {
      ...
      final response = await networkUtils.handleResponse(await networkUtils.buildHttpResponse('/search/suggestions?$queryParams', method: networkUtils.HttpMethod.GET));
  ...
  Future<ApiResponse<List<String>>> getTrendingSearches() async {
    try {
      final response = await networkUtils.handleResponse(await networkUtils.buildHttpResponse('/search/trending', method: networkUtils.HttpMethod.GET));
  ...
  Future<ApiResponse<List<Map<String, dynamic>>>> getSearchHistory() async {
    try {
      final response = await networkUtils.handleResponse(await networkUtils.buildHttpResponse('/search/history', method: networkUtils.HttpMethod.GET));
  ...
  Future<ApiResponse<Map<String, dynamic>>> clearSearchHistory() async {
    try {
      final response = await networkUtils.handleResponse(await networkUtils.buildHttpResponse('/search/history/clear', method: networkUtils.HttpMethod.POST));
      return ApiResponse.success(Map<String, dynamic>.from(response));
    } on ApiException catch (e) {
      return ApiResponse.error(e.message, statusCode: e.statusCode);
    } catch (e) {
  ...
  Future<ApiResponse<Map<String, dynamic>>> saveSearchQuery({required String query, String? category}) async {
    try {
      final response = await networkUtils.handleResponse(
        await networkUtils.buildHttpResponse('/search/history/save', method: networkUtils.HttpMethod.POST, request: {'query': query, if (category != null) 'category': category}),
      );
      return ApiResponse.success(Map<String, dynamic>.from(response));
    } on ApiException catch (e) {
      return ApiResponse.error(e.message, statusCode: e.statusCode);
  ...
  Future<ApiResponse<Map<String, dynamic>>> searchInGroup({required String groupId, required String page, required String keyword}) async {
    try {
      final response = await networkUtils.handleResponse(await networkUtils.buildHttpResponse('/search/group/$groupId?page=$page&keyword=$keyword', method: networkUtils.HttpMethod.POST));
      return ApiResponse.success(Map<String, dynamic>.from(response));
    } on ApiException catch (e) {
      return ApiResponse.error(e.message, statusCode: e.statusCode);
    } catch (e) {
  ...
  Future<ApiResponse<Map<String, dynamic>>> searchConditions({required String page, required String keyword, String? category}) async {
    try {
      String queryParams = 'page=$page&keyword=$keyword';
      if (category != null && category.isNotEmpty) {
        queryParams += '&category=$category';
      ...
      final response = await networkUtils.handleResponse(await networkUtils.buildHttpResponse('/search/conditions?$queryParams', method: networkUtils.HttpMethod.POST));
      return ApiResponse.success(Map<String, dynamic>.from(response));
    } on ApiException catch (e) {
      return ApiResponse.error(e.message, statusCode: e.statusCode);
    } catch (e) {
  ...
  Future<ApiResponse<Map<String, dynamic>>> searchProcedures({required String page, required String keyword, String? specialty}) async {
    try {
      String queryParams = 'page=$page&keyword=$keyword';
      if (specialty != null && specialty.isNotEmpty) {
        queryParams += '&specialty=$specialty';
      ...
      final response = await networkUtils.handleResponse(await networkUtils.buildHttpResponse('/search/procedures?$queryParams', method: networkUtils.HttpMethod.POST));
      return ApiResponse.success(Map<String, dynamic>.from(response));
    } on ApiException catch (e) {
      return ApiResponse.error(e.message, statusCode: e.statusCode);
    } catch (e) {
  ...
  Future<ApiResponse<Map<String, dynamic>>> filterSearchResults({required String query, required String page, Map<String, dynamic>? filters}) async {
    try {
      final request = {'query': query, 'page': page, if (filters != null) ...filters};

      final response = await networkUtils.handleResponse(await networkUtils.buildHttpResponse('/search/filter', method: networkUtils.HttpMethod.POST, request: request));
      return ApiResponse.success(Map<String, dynamic>.from(response));
    } on ApiException catch (e) {
      return ApiResponse.error(e.message, statusCode: e.statusCode);
    } catch (e) {
  ...
  Future<ApiResponse<GuidelinesModel>> searchGuides({required String page, required String keyword}) async {
    try {
      final response = await networkUtils.handleResponse(await networkUtils.buildHttpResponse('/guideline?page=$page&search_term=$keyword', method: networkUtils.HttpMethod.GET));
      return ApiResponse.success(GuidelinesModel.fromJson(response));
    } on ApiException catch (e) {
      return ApiResponse.error(e.message, statusCode: e.statusCode);
    } catch (e) {
  ...
  Future<ApiResponse<CheckInSearchModel>> searchPlaces({required String page, required String query, required String latitude, required String longitude}) async {
    try {
      final response = await networkUtils.handleResponse(
        await networkUtils.buildHttpResponse('/check_in_search?page=$page&name=$query&latitude=$latitude&longitude=$longitude', method: networkUtils.HttpMethod.POST),
      );
